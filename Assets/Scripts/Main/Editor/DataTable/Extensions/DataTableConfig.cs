...
namespace DE.Editor
{
    ...
    public static class DataTableConfig
    {
        ...
        public static readonly string ExcelsFolder = $"{Application.dataPath}/../Excels/Normal";

        /// <summary>
        /// 数据表C#实体类生成文件夹路径
        /// </summary>
        public const string CSharpCodePath = "Assets/Scripts/Main/Runtime/DataTable";
        ...
        /// 数据表命名空间
        /// </summary>
        public const string NameSpace = "MetaArea";
