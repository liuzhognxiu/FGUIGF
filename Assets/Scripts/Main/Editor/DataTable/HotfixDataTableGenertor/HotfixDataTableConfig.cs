...
namespace DE.Editor.DataTableTools
{
    ...
    public static class HotfixDataTableConfig
    {
        ...
        /// 数据表存放文件夹路径
        /// </summary>
        public const string DataTableFolderPath = "Assets/GameMain/HotfixDataTables";
        ...
        /// 数据表C#实体类模板存放路径
        /// </summary>
        public const string CSharpCodeTemplateFileName = "Assets/GameMain/Configs/HotfixDataTableCodeTemplate.txt";

        /// <summary>
        /// 数据表扩展类文件夹路径
        /// </summary>
        public static readonly string ExtensionDirectoryPath = "Assets/Scripts/Main/Runtime/DataTableExtension/Runtime/Extensions";
        
        /// <summary>
        /// 数据表命名空间
        /// </summary>
        public const string NameSpace =  "MetaArea.Hotfix";
