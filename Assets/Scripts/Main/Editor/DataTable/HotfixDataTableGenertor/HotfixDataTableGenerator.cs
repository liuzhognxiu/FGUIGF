...
{
    public static class HotfixDataTableGenerator
    {
        ...
        public static DataTableProcessor CreateDataTableProcessor(string dataTableName)
        {
            return new DataTableProcessor(
                Utility.Path.GetRegularPath(Path.Combine(HotfixDataTableConfig.DataTableFolderPath,
                    dataTableName + ".txt")),
                Encoding.UTF8, 1, 2,
                null, 3, 4, 1);
        }
        ...
        {
            dataTableProcessor.SetCodeTemplate(HotfixDataTableConfig.CSharpCodeTemplateFileName, Encoding.UTF8);
        ...
        {
            string oldCsharpCodePath = Utility.Path.GetRegularPath(Path.Combine(
                HotfixDataTableConfig.HotfixProjectFolder,
                HotfixDataTableConfig.HotfixDataTableFolder, "DR" + dataTableName + ".cs"));
            ...
            var stringBuilder =
                new StringBuilder(File.ReadAllText(HotfixDataTableConfig.CSharpCodeTemplateFileName, Encoding.UTF8));
            ...
            StringBuilder codeContent, object userData)
        {
            ...
            codeContent.Replace("__DATA_TABLE_NAME_SPACE__", HotfixDataTableConfig.NameSpace);
            codeContent.Replace("__DATA_TABLE_CLASS_NAME__", "DR" + dataTableName);
            codeContent.Replace("__DATA_TABLE_BASECLASS_NAME__", "HotfixDataRowBase");
