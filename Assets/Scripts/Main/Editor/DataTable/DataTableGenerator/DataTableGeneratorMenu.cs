...
namespace DE.Editor.DataTableTools
{
    ...
    {
        [MenuItem("Tools/DataTable/Generate DataTables/From Txt", priority= 2)]
        ...
        [MenuItem("Tools/DataTable/Generate DataTables/From Txt Use FileSystem", priority= 20)]
        ...
        [MenuItem("Tools/DataTable/Generate DataTables/From Excel Use FileSystem", priority= 20)]
