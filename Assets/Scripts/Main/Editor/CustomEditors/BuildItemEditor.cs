...
namespace MetaArea.Editor.BuildItem
{
    ...
    /// </summary>
    [CustomEditor(typeof(MetaArea.BuildItem))]
    public class BuildItemEditor : UnityEditor.Editor
    {

        public override void OnInspectorGUI()
        {

            MetaArea.BuildItem obj = (MetaArea.BuildItem) target;
            EditorGUILayout.HelpBox(
                "If you add the prefab with empty fields below, this script will help you to fill the others",
                MessageType.Info);
            ...
            EditorGUILayout.HelpBox(
                "If you don't want to set ghost material for every object that you create, use the tool under Build System menu",
                MessageType.Info);
