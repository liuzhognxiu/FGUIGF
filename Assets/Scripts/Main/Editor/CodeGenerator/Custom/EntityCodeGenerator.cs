...
namespace MetaArea
{
    ...
    public class EntityCodeGenerator : CodeGeneratorBase
    {
        ...
        public EntityCodeGenerator() : base("Assets/Scripts/Main/Runtime/Entity/EntityLogic", "Entity/Custom/EntityLogic")
        {
            ...
            foreach (GameObject go in m_GameObjectRecordableList.GameObjects)
            {
                ...
                if (m_IsGenEntityDataCode)
                {
                    EntityDataCodeGenerator codeGenerator =
                       new EntityDataCodeGenerator("Assets/Scripts/Main/Runtime/Entity/EntityData",
                ...
                if (m_IsGenShowEntityCode)
                {
                   EntityShowCodeGenerator codeGenerator =
                       new EntityShowCodeGenerator("Assets/Scripts/Entity/ShowEntityExtension",
