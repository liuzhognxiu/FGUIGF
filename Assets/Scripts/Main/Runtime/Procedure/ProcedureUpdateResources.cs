...
namespace MetaArea
{
    public class ProcedureUpdateResources : ProcedureBase
    {
        ...
        private UIUpdateResourceFormLogic _mUIUpdateResourceFormLogic = null;
        ...
        protected override async void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            _mUIUpdateResourceFormLogic = null;
            ...
            {
                PopResult result = await GameEntry.UI.OpenDialog(new DialogParams()
                {
                    Mode = 2,
        ...
        {
            if (_mUIUpdateResourceFormLogic != null)
            {
                Object.Destroy(_mUIUpdateResourceFormLogic.gameObject);
                _mUIUpdateResourceFormLogic = null;
            }
        ...
        private void StartUpdateResources(object userData)
        {
            if (_mUIUpdateResourceFormLogic == null)
            {
                _mUIUpdateResourceFormLogic =
                    Object.Instantiate(GameEntry.BuiltinData.UIUpdateResourceFormLogicTemplate);
            }
        ...
        private void RefreshProgress()
        {
            ...
            _mUIUpdateResourceFormLogic.SetProgress(progressTotal, descriptionText);
        }
