...
namespace MetaArea.Hotfix
{
    public class MouseScroll : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            Vector2 localPoint;
            RectTransformUtility.ScreenPointToLocalPointInRectangle(m_ScrollRectTransform, mousePosition, null,
                out localPoint);
        ...
        public void SelectChild(BuildItemLogic levelSelectButton)
        {
            // minus one if  buffer
