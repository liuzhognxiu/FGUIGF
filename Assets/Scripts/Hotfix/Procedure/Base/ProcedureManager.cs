...
namespace MetaArea.Hotfix
{
    ...
    public sealed class ProcedureManager 
    {
        ...
        public ProcedureBase CurrentProcedure
        {
            get
            {
                if (m_ProcedureFsm == null) throw new GameFrameworkException("You must initialize procedure first.");
        ...
        public void Initialize(IFsmManager fsmManager, params ProcedureBase[] procedures)
        {
            ...
            m_ProcedureFsm = m_FsmManager.CreateFsm<ProcedureManager>(this, procedures);
        }
